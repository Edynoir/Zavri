...
import { BookOpen, ShieldCheck, LayoutDashboard, Sparkles, Loader2, LogOut, User as UserIcon, Settings, Moon, Sun, X } from 'lucide-react'
...
function App() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 selection:bg-primary-100 selection:text-primary-900 transition-colors duration-500">
            <SettingsPanel />

            {/* Header */}
            <header className="w-full py-6 px-4 md:px-8 border-b border-slate-200 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50 sticky top-0 z-50 backdrop-blur-md">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-200/40 dark:shadow-none">
                                    <h4 className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-8 px-1">Системийн төлөв</h4>
                                    <div className="space-y-6">
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-3 font-bold">
                                                <div className="w-8 h-8 rounded-lg bg-green-50 dark:bg-green-900/10 text-green-500 flex items-center justify-center">
                                                    <ShieldCheck size={18} />
                                                </div>
                                                <span>Firestore</span>
                                            </div>
                                            <span className="text-[10px] font-bold text-green-500 uppercase tracking-widest bg-green-50 dark:bg-green-950 px-2 py-1 rounded-md">Холбогдсон</span>
                                        </div>
